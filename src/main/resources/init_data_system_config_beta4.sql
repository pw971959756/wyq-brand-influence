...
('ENVIRONMENT_FLAG', 'beta4', '环境标识'),
('JEDIS_SERVER', '10.10.10.20', 'jedis服务地址'),
('JEDIS_PORT', '6379', 'jedis端口'),
('FILE_UPLOAD_PATH', '/home/web/webfiles/files4.wyq.cn/', '文件上传路径'),
('FILE_VIEW_PATH', 'http://files-beta4.51wyq.cn/', '文件预览路径'),
